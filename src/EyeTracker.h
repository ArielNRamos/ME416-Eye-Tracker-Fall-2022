...
class EyeTracker
{
  ...
  private:
    ...
    // This is the subsystem that includes the transformation from the center of the face plate to the eyes
    // and controls the dynamixel servos for the eyes
    Eyes robotEyes;
    
    // This is the subsystem that includes the transformation of the current 3-axis gantry system
    // This will be replaced by the Epson robot arm.

    Shoulder robotShoulder;
    
    // The desired gaze position as written in the scren coordinate system
