...
//    uint16_t goalAngle = 0;
  ...
  protected:
    /*
      T - will be the frame of reference located at the center head mounting platform
      D - will be the frame of reference at the center of the eye mechanisms,
          with Z up, X to the right and Y along the axis of the straight zero degree eyes (when looking from behind)
      L - will be the left eye's frame of reference with the origin at the center of rotation
          and is aligned with the D frame when the zero angle is commanded
      R - will be the right eye's frame of reference with the origin at the center of rotation
          and is aligned with D frame when the zero angle is commanded
    */
  ...
  public:
    ...
    // Calibration function - this is used to jog the eyes and define a zero angle
