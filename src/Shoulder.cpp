...
void Shoulder::MoveShoulderToPosition(float x, float y, float z)
{
  ...
  // TODO: Write out to eeprom after every move so that this value can't be lost

  PromAddress eeAddressXStepper = XStepperPositionAddress;
  PromAddress eeAddressYStepper = YStepperPositionAddress;
  PromAddress eeAddressZStepper = ZStepperPositionAddress;

 // Not entirely sure if this is the correct position for me to pass.
  EEPROM.update(eeAddressXStepper, (this->GetShoulderPosition('x')));
  EEPROM.update(eeAddressYStepper, (this->GetShoulderPosition('y')));
  EEPROM.update(eeAddressZStepper, (this->GetShoulderPosition('z')));
...
{
  PromAddress eeAddress = XStepperPositionAddress;
